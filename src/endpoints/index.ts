export const getStopSearches = (lat: number, lng: number, date: string | undefined): string => {
...
export const getCrimes = (lat: number, lng: number, date: string | undefined): string => {
